...
if [[ -f "$HOME/.local/share/zinit/plugins/zsh-users---zsh-syntax-highlighting/themes/rose_pine-zsh-syntax-highlighting.zsh" ]]; then
    source "$HOME/.local/share/zinit/plugins/zsh-users---zsh-syntax-highlighting/themes/rose_pine-zsh-syntax-highlighting.zsh"
fi
