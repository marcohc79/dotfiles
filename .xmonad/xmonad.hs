...
import XMonad.Util.Cursor           -- Configure cursor
...
--
--myWorkspaces    = [" <fn=2>\xf015 </fn>"," <fn=2>\xf121 </fn>"," <fn=2>\xf120 </fn>"," <fn=2>\xf07b </fn>"," <fn=2>\xf57d </fn>"," <fn=2>\xf03e </fn>"," <fn=2>\xf0c0 </fn>"," <fn=2>\xf025 </fn>"," <fn=2>\xf044 </fn>"]

myWorkspaces    = [" 1 \xf111","2 \xf111","3 \xf111","4 \xf111","5 \xf111"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch powermenu
    , ((modm, xK_x), spawn "~/.config/rofi/bin/powermenu")
    -- launch dmenu
  ...
  [
    ...
    , ((modm .|. shiftMask, xK_comma), rotSlavesDown)
    -- Rotate all windows current stack 
    , ((modm .|. shiftMask, xK_period), rotAllDown)
  ]
  ++
  -- Workspaces
  [
...
--
myLayout = avoidStruts (spacing 15 $ tiled ||| Full)
  where
...
myStartupHook = do
  -- spawnOnce "picom"
  spawnOnce "/home/mhcaballero/.screenlayout/layout.sh"
  spawnOnce "~/.fehbg&"
  setDefaultCursor xC_left_ptr --Mouse
------------------------------------------------------------------------
...
--
main = do
   xmproc <- spawnPipe "xmobar -x 0 /home/mhcaballero/.config/xmobar/xmobar.config"
